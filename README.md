...
## 参考にしたURL
- [GitHub - NVIDIA PhysX](https://github.com/NVIDIAGameWorks/PhysX)
...
- [5系](https://github.com/NVIDIAGameWorks/PhysX)はWindows、Linuxに対応している。 ※当レポジトリでは5系を使用している。<br>[非公式でMac、iOS、Androidに対応したfork](https://github.com/o3de/PhysX)が存在するが、vcpkgでパッケージが提供されているのは公式版だけみたい。
